...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/3mt9wdon/settings/api) and create a token with read rights.
